...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/sightwww/yxip/main/addressesapi.txt' //可参考内容格式 自行搭建。
];

let DLS = 4;//速度下限
let addressescsv = [
	//'https://raw.githubusercontent.com/sightwww/yxip/main/addressescsv.csv' //iptest测速结果文件。
];

let subconverter = "api.v1.mk"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/sightwww/yxip/main/ACL4SSR.ini"; //订阅配置文件
